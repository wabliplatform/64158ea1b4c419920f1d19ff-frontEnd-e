...
(function(root, factory) {
  ...
  describe('Ps', function() {
    it('should create an instance of Ps', function() {
      // uncomment below and update the code to test Ps
      //var instane = new TempApi.Ps();
      //expect(instance).to.be.a(TempApi.Ps);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TempApi.Ps();
